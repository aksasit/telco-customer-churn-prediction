...
def main(args):
    ...
    default_uri = f"sqlite:///{project_root}/mlflow.db"
    ...
    with mlflow.start_run():
        ...
        feature_cols = list(df_enc.drop(columns=[target]))
        ...
        preprocessing_artifact = {
            "feature_columns": feature_cols,  # Extract feature order
            "target": target                  # Target column name
        }
        preprocessing_path = os.path.join(artifacts_dir, "preprocessing")        
...
# Command Line -> argparse -> args object -> main(args) -> ML pipeline runs
